...
class FrameObject:
    def __init__(self) -> None:
        # output infos
        self.update_bms, self.update_norm_bms, self.update_infos, self.update_box = None, None, None, None
        self.predict_bms, self.predict_norm_bms, self.predict_infos, self.predict_box = None, None, None, None
